...
/*!**************************************************!*\
  !*** ./src/components/sort-big-trip-template.js ***!
  \**************************************************/
/*! exports provided: createSortBigTripTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSortBigTripTemplate", function() { return createSortBigTripTemplate; });
...
/* harmony import */ var _components_events_item_big_trip_template__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/events-item-big-trip-template */ "./src/components/events-item-big-trip-template.js");
/* harmony import */ var _components_events_big_trip_template__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/events-big-trip-template */ "./src/components/events-big-trip-template.js");
...
render(siteMainElement, Object(_components_info_big_trip_template__WEBPACK_IMPORTED_MODULE_0__["createInfoBigTripTemplate"])(), `afterBegin`);

const siteInfoElement = document.querySelector(`.trip-info`);

render(siteInfoElement, Object(_components_cost_value_big_trip_template__WEBPACK_IMPORTED_MODULE_1__["createCostValueBigTripTemplate"])(), `beforeEnd`);
render(siteControlsElement, Object(_components_menu_big_trip_template__WEBPACK_IMPORTED_MODULE_2__["createMenuBigTripTemplate"])(), `afterBegin`);
render(siteControlsElement, Object(_components_filters_big_trip_template__WEBPACK_IMPORTED_MODULE_3__["createFiltersBigTripTemplate"])(), `beforeEnd`);
render(siteEventsElement, Object(_components_sort_big_trip_template__WEBPACK_IMPORTED_MODULE_4__["createSortBigTripTemplate"])(), `beforeEnd`);
render(siteEventsElement, Object(_components_events_big_trip_template__WEBPACK_IMPORTED_MODULE_6__["createEventsBigTripTemplate"])(), `beforeEnd`);
render(siteEventsElement, Object(_components_list_big_trip_template__WEBPACK_IMPORTED_MODULE_7__["createListBigTripTemplate"])(), `beforeEnd`);

const siteDaysElement = document.querySelector(`.trip-days`);

render(siteDaysElement, Object(_components_day_big_trip_template__WEBPACK_IMPORTED_MODULE_8__["createDayBigTripTemplate"])(), `beforeEnd`);

const siteListElement = document.querySelector(`.trip-events__list`);

for (let i = 0; i < ROUTE_COUNT; i++) {
  render(siteListElement, Object(_components_events_item_big_trip_template__WEBPACK_IMPORTED_MODULE_5__["createEventsItemBigTripTemplate"])(), `beforeend`);
}
